...
class MLP_Regressor(BaseEstimator, RegressorMixin):
    def __init__(self, input_size, hidden_size=16, output_size=1, learning_rate=1e-3, epochs=20, patience=5, weight_decay=0.1, batch_size=512):
